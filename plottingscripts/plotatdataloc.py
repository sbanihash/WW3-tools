...
def main():
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('atl_hsdiff_JASON3_HR2_day2.png')
    fig.close_figure()    
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('atl_wnddiff_JASON3_HR2_day2.png')
    fig.close_figure()
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('atl_hs_HR2_day2.png')
    fig.close_figure()
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('atl_wnd_HR2_day2.png')
    fig.close_figure()
