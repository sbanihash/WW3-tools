...
def main():
  ...
  for fhr in fhrs:
    print('fhr=',fhr)
    basepath='/work/noaa/marine/jmeixner/Data/HR1/Hurricane/gfs.20200913/00/wave/gridded'
    ...
    titleofplot='HR1 IC 2020091300 fhr %03d' % fhr 
    ...
    figname='wndglobalHR1.f%03d.png' % (fhr)
    ...
    figname='wndatlanticHR1.f%03d.png' % (fhr)
    fig.save_figure(figname )
    fig.close_figure()
