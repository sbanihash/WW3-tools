...
def main():
  fhrs=[3,12,24,36,48,72,96,120,144,168]
  for fhr in fhrs:
    print('fhr=',fhr)
    basepath='/work/noaa/marine/jmeixner/Data/HR2/Hurricane/gfs.20200913/00/products/wave/gridded'
    ...
    titleofplot='HR2 IC 2020091300 fhr %03d' % fhr 
    ...
    figname='wndglobalHR2.f%03d.png' % (fhr)
    ...
    plot2.add_grid()
    plot2.add_colorbar(label='Wind Speed [m]',
                       fontsize=12, extend='neither')
    ...
    figname='wndatlanticHR2.f%03d.png' % (fhr)
    fig.save_figure(figname )
    fig.close_figure()
