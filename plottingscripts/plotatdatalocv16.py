...
def main():
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('atl_hsdiff_JASON3_GFSv16_day2.png')
    fig.close_figure()    
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('atl_wnddiff_JASON3_GFSv16_day2.png')
    fig.close_figure()
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('atl_hs_GFSv16_day2.png')
    fig.close_figure()
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('atl_wnd_GFSv16_day2.png')
    fig.close_figure()
