...
def main():
  ...
  for fhr in fhrs:
    ...
    basepath='/work/noaa/marine/jmeixner/Data/GFSv16/gfs.20200913/00/wave/gridded'
    ...
    titleofplot='GFSv16 IC 2020091300 fhr %03d' % fhr 
    ...
    figname='wndglobalGFSv16.f%03d.png' % (fhr)
    ...
    figname='wndatlanticGFSv16.f%03d.png' % (fhr)
    fig.save_figure(figname )
    fig.close_figure()
