...
def main():
    # Create test data
    datapath='/work/noaa/marine/jmeixner/ww3toolsstep2_2/WW3-tools/ww3tools/multi1hurr_atl_JASON3_2020091300.nc'
    #datapath='/work/noaa/marine/jmeixner/ww3toolsstep2_2/WW3-tools/ww3tools/multi1hurr_JASON3_2020091300.nc'
    ...
    scatter = MapScatter(lats, lons, obs_hs)
    scatter.cmap = 'turbo'
    ...
    plot1.add_title(label='HS [m]', loc='center',
                    fontsize=20)
    plot1.add_colorbar(label='obs (JASON3)',
                       fontsize=12, extend='neither')
    fig = CreateFigure()
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('atl_hs_obs_multi1_day2.png')
    fig.close_figure()    


    scatter = MapScatter(lats, lons, obs_wnd)
    scatter.cmap = 'turbo'
    scatter.markersize = 20
    scatter.vmin=0
    scatter.vmax=40
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('atl_wnd_obs_JASON3_multi1_day2.png')
    fig.close_figure()
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('atl_hs_multi1_day2.png')
    fig.close_figure()
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('atl_wnd_multi1_day2.png')
    fig.close_figure()
