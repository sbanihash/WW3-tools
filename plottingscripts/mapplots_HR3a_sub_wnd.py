...
def main():
  ...
  for fhr in fhrs:
    print('fhr=',fhr)
    basepath='/work/noaa/marine/jmeixner/Data/HR3a/hurricane/gfs.20200913/00/products/wave/gridded'
    ...
    titleofplot='HR3a IC 2020091300 fhr %03d' % fhr 
    ...
    figname='wndglobalHR3a.f%03d.png' % (fhr)
    ...
    figname='wndatlanticHR3a.f%03d.png' % (fhr)
    fig.save_figure(figname )
    fig.close_figure()
