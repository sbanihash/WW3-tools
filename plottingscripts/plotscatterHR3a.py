...
# Create Scatter object
    ...
    plot1.add_title(label='HR3a HS Day1')
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('scatter_HR3aJASON3_hs_day1.png')
    fig.close_figure()    
    sctr1 = Scatter(obs_wnd1, model_wnd1)
    sctr1.density_scatter()
    plot1 = CreatePlot()
    plot1.plot_layers = [sctr1]
    plot1.add_title(label='HR3a Wind Day1')
    plot1.add_xlabel(xlabel='observation (JASON3)')
    plot1.add_ylabel(ylabel='model')
    plot1.add_legend()
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('scatter_HR3aJASON3_wind_day1.png')
    fig.close_figure()
...
#DAY2 
    ...
    plot1 = CreatePlot()
    plot1.plot_layers = [sctr1]
    plot1.add_title(label='HR3a HS Day2')
    plot1.add_xlabel(xlabel='observation (JASON3)')
    plot1.add_ylabel(ylabel='model')
    plot1.add_legend()
    plot1.set_xlim(0,15) #np.nanmax(obs_hs))
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('scatter_HR3aJASON3_hs_day2.png')
    fig.close_figure()
    sctr1 = Scatter(obs_wnd2, model_wnd2)
    sctr1.density_scatter()
    plot1 = CreatePlot()
    plot1.plot_layers = [sctr1]
    plot1.add_title(label='HR3a Wind Day2')
    plot1.add_xlabel(xlabel='observation (JASON3)')
    plot1.add_ylabel(ylabel='model')
    plot1.add_legend()
    plot1.set_xlim(0,35) 
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('scatter_HR3aJASON3_wind_day2.png')
    fig.close_figure()
...
#DAY3 
    ...
    plot1 = CreatePlot()
    plot1.plot_layers = [sctr1]
    plot1.add_title(label='HR3a HS Day3')
    plot1.add_xlabel(xlabel='observation (JASON3)')
    plot1.add_ylabel(ylabel='model')
    plot1.add_legend()
    plot1.set_xlim(0,15) #np.nanmax(obs_hs))
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('scatter_HR3aJASON3_hs_day3.png')
    fig.close_figure()
    sctr1 = Scatter(obs_wnd3, model_wnd3)
    sctr1.density_scatter()
    plot1 = CreatePlot()
    plot1.plot_layers = [sctr1]
    plot1.add_title(label='HR3a Wind Day3')
    plot1.add_xlabel(xlabel='observation (JASON3)')
    plot1.add_ylabel(ylabel='model')
    plot1.add_legend()
    plot1.set_xlim(0,35)
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('scatter_HR3aJASON3_wind_day3.png')
    fig.close_figure()
...
#DAY 5 
    ...
    plot1 = CreatePlot()
    plot1.plot_layers = [sctr1]
    plot1.add_title(label='HR3a HS Day5')
    plot1.add_xlabel(xlabel='observation (JASON3)')
    plot1.add_ylabel(ylabel='model')
    plot1.add_legend()
    plot1.set_xlim(0,15) #np.nanmax(obs_hs))
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('scatter_HR3aJASON3_hs_day5.png')
    fig.close_figure()
    sctr1 = Scatter(obs_wnd5, model_wnd5)
    sctr1.density_scatter()
    plot1 = CreatePlot()
    plot1.plot_layers = [sctr1]
    plot1.add_title(label='HR3a Wind Day5')
    plot1.add_xlabel(xlabel='observation (JASON3)')
    plot1.add_ylabel(ylabel='model')
    plot1.add_legend()
    plot1.set_xlim(0,35)
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('scatter_HR3aJASON3_wind_day5.png')
    fig.close_figure()
...
#DAY 7 
    ...
    plot1 = CreatePlot()
    plot1.plot_layers = [sctr1]
    plot1.add_title(label='HR3a HS Day7')
    plot1.add_xlabel(xlabel='observation (JASON3)')
    plot1.add_ylabel(ylabel='model')
    plot1.add_legend()
    plot1.set_xlim(0,15) #np.nanmax(obs_hs))
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('scatter_HR3aJASON3_hs_day7.png')
    fig.close_figure()
    sctr1 = Scatter(obs_wnd7, model_wnd7)
    sctr1.density_scatter()
    plot1 = CreatePlot()
    plot1.plot_layers = [sctr1]
    plot1.add_title(label='HR3a Wind Day7')
    plot1.add_xlabel(xlabel='observation (JASON3)')
    plot1.add_ylabel(ylabel='model')
    plot1.add_legend()
    plot1.set_xlim(0,35)
    ...
    fig.plot_list = [plot1]
    fig.create_figure()
    fig.save_figure('scatter_HR3aJASON3_wind_day7.png')
    fig.close_figure()
